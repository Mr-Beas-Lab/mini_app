...
const CryptoAnalyzer: React.FC = () => {
  ...
  {/* Main Content */}
  <div
    className={`flex justify-between px-4 py-2 bg-gray-900 text-white ${
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <select
                ...
                className="px-3 py-2 w-full bg-gray-800 text-gray-300 border rounded-md focus:ring text-primary focus:ring-yellow focus:outline-none"
              >
