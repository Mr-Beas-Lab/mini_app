...
const BottomNav = () => {
  ...
  return (
    <footer className=" bottom-0">
      <nav className="fixed  w-full px-5 py-3  left-0 bottom-0 bg-[#00bfff] flex justify-around items-center shadow-md">
        <Btn
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center w-[50px] h-[50px] rounded-full transition-all duration-300 ${
        currentScreen === url
          ? "bg-gradient-to-b from-blue-light to-blue-medium border-2 border-white text-white "
          : "text-white"
      }`}
    >
      {icon}
